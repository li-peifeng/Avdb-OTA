...
- Release：[`20260905-1713`](https://github.com/li-peifeng/Avdb-OTA/releases/tag/20260905-1713)
- Manifest：[`manifest.json`](https://github.com/li-peifeng/Avdb-OTA/releases/download/20260905-1713/manifest.json)
- 版本：`20260905-1713`
- 加密包：[`avdb-20260905-1713.pkg.enc`](https://github.com/li-peifeng/Avdb-OTA/releases/download/20260905-1713/avdb-20260905-1713.pkg.enc)
- 签名算法：Ed25519
- 签名 `key_id`：`2026-next`
- 加密算法：AES-256-GCM
- 更新方式：`应用内 OTA`
