...
- Release：[`20260829-0047`](https://github.com/li-peifeng/Avdb-OTA/releases/tag/20260829-0047)
- Manifest：[`manifest.json`](https://github.com/li-peifeng/Avdb-OTA/releases/download/20260829-0047/manifest.json)
- 版本：`20260829-0047`
- 加密包：[`avdb-20260829-0047.pkg.enc`](https://github.com/li-peifeng/Avdb-OTA/releases/download/20260829-0047/avdb-20260829-0047.pkg.enc)
- 签名算法：Ed25519
- 签名 `key_id`：`2026-next`
- 加密算法：AES-256-GCM
- 更新方式：`应用内 OTA`
- 更新摘要：
  ...
  登录请至 设置-个人-在线账户，登录 Javdb 账户，支持多设备登录。
