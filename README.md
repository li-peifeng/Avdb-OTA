...
- Release：[`20260821-0209`](https://github.com/li-peifeng/Avdb-OTA/releases/tag/20260821-0209)
- Manifest：[`manifest.json`](https://github.com/li-peifeng/Avdb-OTA/releases/download/20260821-0209/manifest.json)
- 版本：`20260821-0209`
- 加密包：[`avdb-20260821-0209.pkg.enc`](https://github.com/li-peifeng/Avdb-OTA/releases/download/20260821-0209/avdb-20260821-0209.pkg.enc)
- 签名算法：Ed25519
- 签名 `key_id`：`2026-next`
- 加密算法：AES-256-GCM
- 更新方式：`Docker 镜像`
