...
- Release：[`20260831-1545`](https://github.com/li-peifeng/Avdb-OTA/releases/tag/20260831-1545)
- Manifest：[`manifest.json`](https://github.com/li-peifeng/Avdb-OTA/releases/download/20260831-1545/manifest.json)
- 版本：`20260831-1545`
- 加密包：[`avdb-20260831-1545.pkg.enc`](https://github.com/li-peifeng/Avdb-OTA/releases/download/20260831-1545/avdb-20260831-1545.pkg.enc)
- 签名算法：Ed25519
- 签名 `key_id`：`2026-next`
- 加密算法：AES-256-GCM
- 更新方式：`应用内 OTA`
