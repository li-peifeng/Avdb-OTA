...
- Release：[`20260826-0230`](https://github.com/li-peifeng/Avdb-OTA/releases/tag/20260826-0230)
- Manifest：[`manifest.json`](https://github.com/li-peifeng/Avdb-OTA/releases/download/20260826-0230/manifest.json)
- 版本：`20260826-0230`
- 加密包：[`avdb-20260826-0230.pkg.enc`](https://github.com/li-peifeng/Avdb-OTA/releases/download/20260826-0230/avdb-20260826-0230.pkg.enc)
- 签名算法：Ed25519
- 签名 `key_id`：`2026-next`
- 加密算法：AES-256-GCM
- 更新方式：`应用内 OTA`
- 更新摘要：
  R18 数据库现已支持增量更新，支持 Gitee 下载
  优化资源库导出并上传仓库的流程
