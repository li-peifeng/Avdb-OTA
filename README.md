...
- 版本：`20260816-0141`
- 加密包：[`avdb-20260816-0141.pkg.enc`](./avdb-20260816-0141.pkg.enc)
- 签名算法：Ed25519
- 签名 `key_id`：`2026-next`
- 加密算法：AES-256-GCM
...
可以从本仓库取得后审阅并挂载到部署端。旧版本使用 `2026-main`，当前发布版本
使用的签名 `key_id` 以 `manifest.json` 为准。
...
`2026-next`，旧版本使用 `2026-main`，当前发布版本使用 Manifest 指定的签名密钥，
AES 解密密钥保持不变。
